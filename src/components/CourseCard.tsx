  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-[#f9ab00]/10">
      ...
      <div className="mt-4 flex items-center gap-1 text-sm font-medium text-[#f9ab00] opacity-0 translate-y-1 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
